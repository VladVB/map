		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest),
                                ...
                                array('label'=>'Пользователи', 'url'=>array('/admin/user'), 'visible'=>Yii::app()->user->checkAccess(ROLE_ADMIN)),
                                array('label'=>'Адреса', 'url'=>array('/admin/locations'), 'visible'=>Yii::app()->user->checkAccess(ROLE_ADMIN)),
                                array('label'=>'Карта', 'url'=>array('/site/map'))
			),
		)); ?>
	</div><!-- mainmenu -->
